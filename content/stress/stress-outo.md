---
title: ストレスで嘔吐するのはなぜ？体からのSOSサインと受診の目安
description: 仕事のストレスで嘔吐や吐き気が続くのはなぜ？心と体の関係をやさしく解説し、今すぐできる対処法、医療機関を受診すべき目安、繰り返す場合に考えたい働き方の見直しまで、自分を守るための情報を整理します。
slug: stress-outo
category: stress
tags: [ストレス, 嘔吐, 吐き気]
date: 2026-06-30
...
<div class="character-box character-box-reverse">
  <img src="/images/characters/character_014.webp" alt="疲れた表情で悩む人" class="character-img">
  <div class="speech-bubble">「そういえば、吐き気だけじゃない。最近は夜中に何度も目が覚めるし、通勤中に急に涙が出たこともあった。全部つながっていたのかもしれない…」</div>
</div>
...
「まだ働けているから大丈夫」と思うかもしれません。でも、吐きながら出社している状態は、すでに「大丈夫」ではないのかもしれません。[仕事中の動悸が伝えていること](/articles/stress/doki-ga-suru/)や[ストレスで眠れないまま朝を迎えるときの対処](/articles/stress/nemurenai-asa/)は、それぞれ別の記事で詳しく整理しています。また、仕事のストレスが限界に近づいたときのサインと「休む・辞める」の判断まで含めた全体像は、[仕事のストレスが限界のときに体に出るサイン](/articles/stress/shigoto-stress-genkai/)にまとめています。あわせて自分の状態を確認してみてください。
...
それでも状況が変わらない場合や、すでに心身の消耗が大きい場合には、休職という選択肢もあります。休職は「逃げ」ではなく、治療と回復のために制度として用意されているものです。休職を考え始めた人は、[休職に必要な診断書のもらい方や手続き](/articles/burnout/kyushoku-shindan/)を整理した記事も参考にしてみてください。また、気分の落ち込みや興味の喪失が続いていて、[仕事が原因のうつのサイン](/articles/stress/shigoto-utsu/)が気になる場合は、早めに心療内科などの専門機関に相談することをおすすめします。
...
<div style="font-size:14px;font-weight:700;color:#1E293B;margin-bottom:6px;line-height:1.6;">「今の職場だけがすべてじゃない」と知っておくことも、自分を守る準備になります</div>
<div style="font-size:13px;color:#475569;margin-bottom:10px;line-height:1.7;">今すぐ転職を決める必要はありません。ただ、体調を崩すほどの環境にいるなら、外にどんな選択肢があるかを知っておくだけでも、「ここで耐えるしかない」という追い詰められた感覚が和らぐことがあります。働き方を見直したくなったときの相談先のひとつとして、転職エージェントという手段もあります。</div>
<div style="font-size:12px;color:#64748B;margin-bottom:14px;line-height:1.7;">※ここでご紹介している「テックゴー」は、ITエンジニアをはじめとするIT職種の方向けの転職エージェントです。IT以外の職種の方は、総合型の転職エージェントやハローワークなど、ご自身の状況に合った相談先を選んでみてください。</div>
...
身近に相談できる人がいないときは、公的な相談窓口を頼ることもできます。厚生労働省が運営する働く人のメンタルヘルス・ポータルサイト「[こころの耳](https://kokoro.mhlw.go.jp/)」では、電話相談「こころの耳電話相談」（0120-565-455）のほか、SNSやメールでの相談も受け付けています。また、厚生労働省の相談窓口案内サイト「[まもろうよ こころ](https://www.mhlw.go.jp/mamorouyokokoro/)」では、こころの健康相談統一ダイヤル（0570-064-556）をはじめ、状況に応じたさまざまな相談窓口が紹介されています。受付時間や最新の連絡先は、必ず各公式サイトでご確認ください。あなたのつらさは、ひとりで抱え込まなくていいものです。

## よくある質問

<details style="border-bottom:1px solid #E2E8F0">
<summary style="background:#EFF6FF;padding:16px 20px;font-weight:600;color:#1E40AF;font-size:14px;cursor:pointer;list-style:none;display:flex;justify-content:space-between;align-items:center">Q1. 熱もないのに吐くのは、本当にストレスが原因なのでしょうか？<span style="font-size:18px;color:#93C5FD">+</span></summary>
<div style="padding:16px 20px;font-size:14px;line-height:1.8;color:#334155">強いストレスが自律神経を通じて胃腸に影響し、発熱などをともなわずに吐き気や嘔吐が起こることはありうると考えられています。ただし、原因がストレスかどうかは自己判断では確かめられません。症状が続く場合は、一度医療機関で体の状態を診てもらうことをおすすめします。</div>
</details>
<details style="border-bottom:1px solid #E2E8F0">
<summary style="background:#EFF6FF;padding:16px 20px;font-weight:600;color:#1E40AF;font-size:14px;cursor:pointer;list-style:none;display:flex;justify-content:space-between;align-items:center">Q2. ストレスによる嘔吐が疑われるとき、何科を受診すればいいですか？<span style="font-size:18px;color:#93C5FD">+</span></summary>
<div style="padding:16px 20px;font-size:14px;line-height:1.8;color:#334155">まずは内科や消化器内科で、体の病気が隠れていないかを確認してもらうのが一般的です。検査で大きな異常がなく、ストレスや気分の落ち込みが強いと感じる場合は、心療内科や精神科への相談も選択肢になります。迷うときは、受診した医師にそのまま相談してみてください。</div>
</details>
<details style="border-bottom:1px solid #E2E8F0">
<summary style="background:#EFF6FF;padding:16px 20px;font-weight:600;color:#1E40AF;font-size:14px;cursor:pointer;list-style:none;display:flex;justify-content:space-between;align-items:center">Q3. 吐き気を理由に仕事を休んでもいいのでしょうか？<span style="font-size:18px;color:#93C5FD">+</span></summary>
<div style="padding:16px 20px;font-size:14px;line-height:1.8;color:#334155">吐き気や嘔吐は立派な体調不良であり、休む理由として十分だと考えられます。無理に出社を続けることで症状が長引いてしまう人もいるようです。休むことに罪悪感を覚えるかもしれませんが、体を守ることを優先し、続くようであれば受診や職場への相談も検討してみてください。</div>
</details>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "熱もないのに吐くのは、本当にストレスが原因なのでしょうか？",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "強いストレスが自律神経を通じて胃腸に影響し、発熱などをともなわずに吐き気や嘔吐が起こることはありうると考えられています。ただし、原因がストレスかどうかは自己判断では確かめられません。症状が続く場合は、一度医療機関で体の状態を診てもらうことをおすすめします。"
      }
    },
    {
      "@type": "Question",
      "name": "ストレスによる嘔吐が疑われるとき、何科を受診すればいいですか？",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "まずは内科や消化器内科で、体の病気が隠れていないかを確認してもらうのが一般的です。検査で大きな異常がなく、ストレスや気分の落ち込みが強いと感じる場合は、心療内科や精神科への相談も選択肢になります。迷うときは、受診した医師にそのまま相談してみてください。"
      }
    },
    {
      "@type": "Question",
      "name": "吐き気を理由に仕事を休んでもいいのでしょうか？",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "吐き気や嘔吐は立派な体調不良であり、休む理由として十分だと考えられます。無理に出社を続けることで症状が長引いてしまう人もいるようです。休むことに罪悪感を覚えるかもしれませんが、体を守ることを優先し、続くようであれば受診や職場への相談も検討してみてください。"
      }
    }
  ]
}

...
<div style="font-size:14px;font-weight:800;color:#EF4444;margin:16px 0 10px;padding:6px 12px;background:#FEF2F2;border-radius:6px"><svg width="12" height="12" viewBox="0 0 12 12" style="vertical-align:-1px"><circle cx="6" cy="6" r="6" fill="#EF4444"/></svg> 体のサイン</div>
<div id="body-checks">
...
<div style="font-size:14px;font-weight:800;color:#F59E0B;margin:20px 0 10px;padding:6px 12px;background:#FFFBEB;border-radius:6px"><svg width="12" height="12" viewBox="0 0 12 12" style="vertical-align:-1px"><circle cx="6" cy="6" r="6" fill="#F59E0B"/></svg> 感情のサイン</div>
...
<div style="font-size:14px;font-weight:800;color:#7C3AED;margin:20px 0 10px;padding:6px 12px;background:#F5F3FF;border-radius:6px"><svg width="12" height="12" viewBox="0 0 12 12" style="vertical-align:-1px"><circle cx="6" cy="6" r="6" fill="#7C3AED"/></svg> 行動のサイン</div>
...
function calcGenkai(){
  ...
  if(total===0){
    ...
    '<br><br><a href="/stress-check/" style="color:#2563EB;font-weight:700">AIコーチに相談する（無料）</a>';
